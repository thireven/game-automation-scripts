...
var LogsEn = {
  ...
  [Log.Unlock.MyTsumCapped]: 'MyTsum is at its level cap',
  [Log.Unlock.MyTsumStart]: 'Raising the MyTsum\'s level cap',
  [Log.Unlock.MyTsumNotSelected]: 'Collection is not showing the MyTsum; not raising',
  [Log.Unlock.MyTsumBackoff]: 'MyTsum raise failed; trying again later',
  [Log.Unlock.MyTsumEnd]: 'MyTsum level-cap raise done',
